...
with st.sidebar:
    ...
    st.markdown("- Go to github.com/parag2884/rivulet-llm-studio")
    ...
    st.markdown("- Navigate to github.com/parag2884/rivulet-llm-studio, scroll down, and report details")
