...
![demo](https://github.com/mvanhorn/rivulet-llm-studio/releases/download/demo-assets/commit-archaeologist.gif)

## Install

```bash
npx skills add https://github.com/parag2884/rivulet-llm-studio/tree/main/agent_skills/commit-archaeologist
```
...
Part of [rivulet-llm-studio](https://github.com/parag2884/rivulet-llm-studio).
