...
![Scope Creep Detector demo](https://github.com/mvanhorn/rivulet-llm-studio/releases/download/demo-assets/scope-creep-detector.gif)
...
```bash
npx skills add https://github.com/parag2884/rivulet-llm-studio/tree/main/agent_skills/scope-creep-detector
```
