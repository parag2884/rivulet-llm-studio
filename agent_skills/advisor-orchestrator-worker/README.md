...
```bash
npx skills add https://github.com/parag2884/rivulet-llm-studio/tree/main/agent_skills/advisor-orchestrator-worker
```
...
Part of [rivulet-llm-studio](https://github.com/parag2884/rivulet-llm-studio) · Apache-2.0 · Last verified: September 2026
