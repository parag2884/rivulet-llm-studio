...
try:
    from settings import live_model_id, sketch_model_id
except ImportError:
    live_model_id = lambda: os.getenv("FNOL_GEMINI_LIVE_MODEL", "gemini-3.8-live")  # noqa: E731
    sketch_model_id = lambda: os.getenv("FNOL_SKETCH_MODEL", "gemini-3.1-flash-image")  # noqa: E731

LIVE_MODEL_ID = live_model_id()
SKETCH_MODEL_ID = sketch_model_id()
